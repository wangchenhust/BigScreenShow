...
资本充足率、核心资本充足率、核心一级资本充足率、流动性比例、资本利润率
...
5个指标：资本充足率、核心资本充足率、核心一级资本充足率、流动性比例、资本利润率
...
五个指标：资本充足率、核心资本充足率、核心一级资本充足率、流动性比例、资本利润率
...
表头：公司、资本充足率、核心资本充足率、流动性比例、资本利润率
...
> 可配置的数据接口和其他图不一样
>
> 是这样的：http://localhost:8088/GetData/CLine/{id}
>
> 其中id可以为{1,2,3,4}，1表示工商银行、2表示农业银行、3表示建设银行、4表示中国银行
>
> 例如：http://localhost:8088/GetData/CLine/1
>
> JSON数据：

> 以工商银行为例子：
>
> [{"bank":"工商银行","name":"核心资本充足率","value":12.7},
>
> {"bank":"工商银行","name":"资产利润率","value":1.7},
>
> {"bank":"工商银行","name":"资本充足率","value":15.2}]
...
> 可配置的数据接口和其他图不一样
>
> 是这样的：http://localhost:8088/GetData/CRada/{id}
>
> 其中id可以为{1,2,3,4}，1表示工商银行、2表示农业银行、3表示建设银行、4表示中国银行
>
> 例如：http://localhost:8088/GetData/CRada/1
>
> 返回JSON数据示例：
